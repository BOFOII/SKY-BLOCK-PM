...
class ShellyGenerator extends IslandGenerator
{
    ...
    public function generateChunk(ChunkManager $world, int $chunkX, int $chunkZ): void
    {
        if ($chunkX == 0 && $chunkZ == 0) {
            ...
            $world->setBlockAt(10, 34, 10, VanillaBlocks::GRASS());
            ...
            $world->setBlockAt(9, 34, 10, VanillaBlocks::GRASS());
            ...
            $world->setBlockAt(9, 34, 9, VanillaBlocks::GRASS());
            ...
            $world->setBlockAt(8, 34, 10, VanillaBlocks::GRASS());
            ...
            $world->setBlockAt(8, 34, 9, VanillaBlocks::GRASS());
            ...
            $world->setBlockAt(8, 34, 8, VanillaBlocks::GRASS());
            ...
            $world->setBlockAt(7, 34, 9, VanillaBlocks::GRASS());
            ...
            $world->setBlockAt(7, 34, 8, VanillaBlocks::GRASS());
            $world->setBlockAt(7, 33, 8, VanillaBlocks::DIRT());
            ...
            $world->setBlockAt(6, 35, 8, VanillaBlocks::CHEST());
